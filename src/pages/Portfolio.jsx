  ...
  return (
    <main className="site-shell">
      ...
      <section className="final-cta">
        <div className="final-particles" aria-hidden="true"><PurpleParticles particleCount={reduceMotion ? 0 : 360} particleSpread={19} speed={2.2} particleColors={finalParticleColors} moveParticlesOnHover={false} particleHoverFactor={0} alphaParticles particleBaseSize={30} sizeRandomness={2.8} cameraDistance={38} disableRotation pixelRatio={1.25} intensity={0.34} /></div>
