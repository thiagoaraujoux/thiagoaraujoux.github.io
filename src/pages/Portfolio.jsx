...
const finalParticleColors = ['#d9d2ff', '#9a7cff', '#6f5dd3', '#88b9ff'];
  ...
  return (
    <main className="site-shell">
      ...
      <section className="final-cta">
        <div className="final-particles" aria-hidden="true"><PurpleParticles particleCount={reduceMotion ? 0 : 280} particleSpread={18} speed={0.12} particleColors={finalParticleColors} moveParticlesOnHover={false} particleHoverFactor={0} alphaParticles particleBaseSize={48} sizeRandomness={2.2} cameraDistance={38} disableRotation pixelRatio={1.25} intensity={0.48} /></div>
