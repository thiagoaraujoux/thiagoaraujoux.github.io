...
import PurpleParticles from '../components/PurpleParticles/PurpleParticles';
...
const finalParticleColors = ['#ffffff', '#ffffff', '#f5f7ff', '#dfe8ff'];
  ...
  return (
    <main className="site-shell">
      ...
      <section className="final-cta">
        <div className="final-particles final-particles-left" aria-hidden="true"><PurpleParticles particleCount={reduceMotion ? 0 : 220} particleSpread={15} speed={2.2} particleColors={finalParticleColors} moveParticlesOnHover={false} particleHoverFactor={0} alphaParticles particleBaseSize={30} sizeRandomness={2.8} cameraDistance={38} disableRotation pixelRatio={1.25} intensity={0.34} /></div>
        <div className="final-particles final-particles-right" aria-hidden="true"><PurpleParticles particleCount={reduceMotion ? 0 : 220} particleSpread={15} speed={1.8} particleColors={finalParticleColors} moveParticlesOnHover={false} particleHoverFactor={0} alphaParticles particleBaseSize={30} sizeRandomness={2.8} cameraDistance={38} disableRotation pixelRatio={1.25} intensity={0.34} /></div>
        <div className="cta-planet" aria-hidden="true"><i /><i /><span>✦</span></div>
        <div className="final-cta-content reveal-block"><span className="section-kicker">PRONTO PARA SAIR DO MANUAL?</span><h2>Vamos colocar sua<br /><em>operação em órbita.</em></h2><p>Me conte como seu atendimento funciona hoje. Eu te mostro o que pode ser automatizado e preparo um orçamento sob medida.</p><a href={WHATSAPP_URL} target="_blank" rel="noreferrer" className="button-primary button-large"><span>Solicitar orçamento no WhatsApp</span><b>↗</b></a><small>Resposta direta • Sem compromisso • Projeto personalizado</small></div>
      </section>
